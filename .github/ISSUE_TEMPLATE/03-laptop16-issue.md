...
about: Laptop 16 Issue related to Firmware/Software/Drivers
title: '[Laptop 16] '
labels: 'Laptop 16'
assignees: ''
...
* Port the Peripheral was connected to. Please see the following for port numbering: [Laptop 16](https://knowledgebase.frame.work/expansion-card-slot-functionality-on-framework-laptop-16-rkUjGm7cn)
